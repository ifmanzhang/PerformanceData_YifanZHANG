...
export const CONTROL_PARAMS = [
  ...
  { id: "glassWind.filmSimResolution", label: "物理场分辨率", group: "glassWind", type: "number", min: 128, max: 512, step: 64, default: 384, target: "glassWind.filmSimResolution", applyMode: "live" },
  { id: "glassWind.filmSubsteps", label: "物理子步数", group: "glassWind", type: "number", min: 1, max: 24, step: 1, default: 8, target: "glassWind.filmSubsteps", applyMode: "live" },
  { id: "glassWind.filmPressureIterations", label: "压力投影迭代", group: "glassWind", type: "number", min: 4, max: 96, step: 1, default: 56, target: "glassWind.filmPressureIterations", applyMode: "live" },
  { id: "glassWind.filmPrewarmSteps", label: "首次物理预热步数", group: "glassWind", type: "number", min: 0, max: 480, step: 1, default: 96, target: "glassWind.filmPrewarmSteps", applyMode: "live" },
  { id: "glassWind.filmSolver", label: "薄膜求解器", group: "glassWind", type: "select", default: "huangCore", target: "glassWind.filmSolver", applyMode: "live", options: [
    { value: "huangCore", label: "Huang 2020 球面核心" },
    { value: "legacy", label: "Legacy GPU 对照" },
  ] },
  { id: "glassWind.filmHuangScenario", label: "Huang 物理场景", group: "glassWind", type: "select", default: "referenceFlow", target: "glassWind.filmHuangScenario", applyMode: "live", options: [
    { value: "referenceFlow", label: "参考混合流" },
    { value: "gravityDrainage", label: "纯重力排液" },
    { value: "marangoniPatch", label: "Marangoni 斑块" },
    { value: "airflowShear", label: "外部气流剪切" },
  ] },
  { id: "glassWind.filmDebugView", label: "物理场视图", group: "glassWind", type: "select", default: "beauty", target: "glassWind.filmDebugView", applyMode: "live", options: [
    { value: "beauty", label: "综合渲染" },
    { value: "solid", label: "纯色壳层" },
    { value: "thickness", label: "膜厚" },
    { value: "velocity", label: "速度" },
    { value: "surfactant", label: "表活剂" },
    { value: "phase", label: "相场/薄区" },
    { value: "foam", label: "泡沫/微滴" },
    { value: "phaseSupport", label: "相场支撑" },
    { value: "regionalRawSupport", label: "区域原始支撑" },
    { value: "regionalSupport", label: "区域支撑" },
    { value: "regionalRidge", label: "区域脊线" },
    { value: "regionalFlow", label: "区域流向" },
    { value: "riverCore", label: "河道核心支撑" },
    { value: "riverCoreRawMass", label: "河道原始核心质量" },
    { value: "riverPathRawEvidence", label: "河道原始路径代价" },
    { value: "riverPathEvidence", label: "河道路径证据" },
    { value: "riverCoreGeodesic", label: "河道测地前沿" },
    { value: "riverCoreMass", label: "河道传输核心质量" },
    { value: "riverPhase", label: "河道相场" },
    { value: "riverFlux", label: "河道高度通量" },
    { value: "riverPathCost", label: "河道路径代价分量" },
    { value: "riverPathSkeleton", label: "河道路径骨架" },
    { value: "phaseArea", label: "相场区域面积误差" },
    { value: "phaseAreaSkeleton", label: "相场骨架/填充拆分" },
    { value: "channelPotential", label: "原始窄通道/宽片排斥" },
    { value: "phaseAreaError", label: "相场面积缺口/过量" },
    { value: "foamAreaError", label: "泡沫面积缺口/过量" },
    { value: "filamentConnectivity", label: "球面细丝连通性" },
    { value: "gammaResidual", label: "Gamma 投影残差" },
    { value: "etaGammaVelocity", label: "eta/Gamma/u 诊断" },
    { value: "huangDivergence", label: "Huang -div_s(u)" },
    { value: "huangGradGamma", label: "Huang grad_s(Gamma)" },
    { value: "huangMarangoniGate", label: "Huang Marangoni gate" },
    { value: "huangNarrowGate", label: "Huang narrow gate" },
    { value: "huangFrontState", label: "Huang front state" },
    { value: "huangResidualTransport", label: "Huang residual transport" },
    { value: "huangMapState", label: "Huang map state" },
    { value: "huangForwardMapState", label: "Huang forward map state" },
    { value: "huangPolarReject", label: "Huang polar reject" },
    { value: "divergenceAfterGammaProjection", label: "Huang 投影后散度" },
    { value: "uAfterMarangoni", label: "Huang Marangoni 后速度" },
    { value: "huangMobilityDivergence", label: "Huang div((M/eta)grad Gamma)" },
    { value: "huangGammaResidual", label: "Huang Gamma 残差" },
    { value: "huangEtaContinuity", label: "Huang eta 连续性残差" },
    { value: "gammaCandidate", label: "Huang Gamma 候选场" },
    { value: "gammaRhsResidual", label: "Huang Gamma RHS 残差" },
  ] },
  ...
  { id: "glassWind.filmDiffusionAmount", label: "液膜晕染扩散", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.24, target: "glassWind.filmDiffusionAmount", applyMode: "live" },
  ...
  { id: "glassWind.filmGravity", label: "表面重力", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.72, target: "glassWind.filmGravity", applyMode: "live" },
  { id: "glassWind.filmViscosity", label: "液膜粘性", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.35, target: "glassWind.filmViscosity", applyMode: "live" },
  { id: "glassWind.filmMarangoniStrength", label: "表面张力差流", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.72, target: "glassWind.filmMarangoniStrength", applyMode: "live" },
  { id: "glassWind.filmCapillaryStrength", label: "毛细回缩", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.52, target: "glassWind.filmCapillaryStrength", applyMode: "live" },
  { id: "glassWind.filmDrainageAmount", label: "重力排液", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.58, target: "glassWind.filmDrainageAmount", applyMode: "live" },
  { id: "glassWind.filmSourceAmount", label: "膜液补给", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.36, target: "glassWind.filmSourceAmount", applyMode: "live" },
  { id: "glassWind.filmFoamSource", label: "微滴生成", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 1.12, target: "glassWind.filmFoamSource", applyMode: "live" },
  { id: "glassWind.filmFoamDecay", label: "微滴衰减", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.18, target: "glassWind.filmFoamDecay", applyMode: "live" },
  ...
  { id: "glassWind.filmInterferenceScale", label: "干涉膜厚尺度", group: "glassWind", type: "number", min: 0.4, max: 2.2, step: 0.01, default: 1.42, target: "glassWind.filmInterferenceScale", applyMode: "live" },
  { id: "glassWind.filmInterferenceContrast", label: "干涉色强度", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.92, target: "glassWind.filmInterferenceContrast", applyMode: "live" },
  ...
  { id: "glassWind.filmSpeckleAmount", label: "液膜颗粒感", group: "glassWind", type: "number", min: 0, max: 1.8, step: 0.01, default: 1.24, target: "glassWind.filmSpeckleAmount", applyMode: "live" },
