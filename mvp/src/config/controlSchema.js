...
export const CONTROL_PARAMS = [
  ...
  { id: "glassWind.filmInterferenceContrast", label: "干涉色强度", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.46, target: "glassWind.filmInterferenceContrast", applyMode: "live" },
