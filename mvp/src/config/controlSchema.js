...
export const CONTROL_PARAMS = [
  ...
  { id: "glassWind.filmSourceAmount", label: "膜液补给", group: "glassWind", type: "number", min: 0, max: 1.5, step: 0.01, default: 0.7, target: "glassWind.filmSourceAmount", applyMode: "live" },
